var endpoints = {
  '/grid/': [{name: 'Codes', slug: 'codes', kind: 'folder', children: []},
              {name: 'Music', slug: 'music', kind: 'folder', expanded: true, children: []},
              {name: "Don't open me", slug: 'error', kind: 'folder', children: []}],
  '/grid/codes': [{name: 'foo.py', kind: 'item'}, {name: 'bar.js', kind: 'item'}],
  '/grid/music': [{name: 'psycho-killer.mp3', kind: 'item'},
                  {name: 'Stones', expanded: true, kind: 'folder', slug: 'music/stones'}],
  '/grid/music/stones': [{name: 'brownsugar.mp3', kind: 'item'}]
};
