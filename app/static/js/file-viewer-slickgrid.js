...
function hGridSlickInit(grid, dataView, data){
//    prep(hGridInfo);
...
//Sets functions for moving rows, sorting, etc.
    function initialize(grid, dataView, data){
//        var src = [];
//        var dest = "";
...
//            onSort(e, args, grid, dataView, data);
//        });

    }


//    function sortHierarchy(data){
//        var sorted = data.sort(HGrid.comparer);
//        var hierarchical = [];
...
//    function onSort(e, args, grid, dataView, data){
//        sortAsc = !sortAsc;
////        sortcol = args.sortCol.field;
//        var new_data = sortHierarchy(data);
//        HGrid.prepJava(new_data);
//        dataView.setItems(data);
//        grid.invalidate();
